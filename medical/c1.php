...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <a href="#" class="navbar-brand text-primary font-weight-bold font-weight-bolder">Medical</a>
    <button class="navbar-toggler" id="bn1">
        <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="callnav">
        <ul class="navbar-nav text-center ml-auto">
            <li class="nav-item"><a href="MedicalHome.php" class="nav-link" id="n1">HOME</a>
            </li>
            </li>
...
<div class="container-fluid" style="min-height: 500px; background: url('../background/medical.jpg'); background-size: 100%;">